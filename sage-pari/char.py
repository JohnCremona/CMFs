...
def DirichletCharacterGaloisReps(N):
    ...
    if N not in DCGR_cache:
        ...
        vv = [[[DC.multiplicative_order(chi)] + character_traces(DC.sage_character(chi)),i]
...
def char_orbit_index_to_DC_number(N, o):
    """
    Return the index in the Dirichlet-Conrey numbering of one character in orbit number o
    """
    if o == 1:
        return 1
