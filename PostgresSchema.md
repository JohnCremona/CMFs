...
hecke_ring_generator_nbound | smallint | minimal integer m such that a_1,...,a_m generate the Hecke ring
...
inner_twist_count | integer | number of inner twists (includes proved and unproved)
